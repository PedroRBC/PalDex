...
export default function TypeBackground({ type, children }: TypeBackgroundProps) {
  const { setCurrentType } = useType()
  ...
  return (
    <div className={cn("min-h-screen bg-gradient-to-br rounded-xl", getTypeGradient(type), "relative overflow-hidden")}>
      {/* Animated background */}
